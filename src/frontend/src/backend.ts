...
export class Backend implements backendInterface {
    ...
    async addQuote(arg0: string, arg1: string): Promise<void> {
    ...
    async getAuthorQuotes(arg0: string): Promise<Array<Quote>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAuthorQuotes(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getQuotesSortedByAuthor(): Promise<Array<Quote>> {
        if (this.processError) {
            try {
                const result = await this.actor.getQuotesSortedByAuthor();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
